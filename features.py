...
@author: kieran
'''
from spectral_tools import Pickle_Template,apply_window,get_band, Sav_Template
...
lines=[Line('H_alpha',5900.,6600.,6562.81,'r'),
       Line('He',5350.,6000.,5876.,'V'),
       Line('He',5350.,6000.,5876.,'r'),
       Line('Ca_III',7800.,8800.,8542.,'i')]
...
#sn_GP=Pickle_Template('meanspec/meanspec_GPinterp.p',continuum='one')
#sn=Sav_Template('IIb_1specperSN')
#sn=Pickle_Template('../truemeansp.p',continuum='one')
#sn=Pickle_Template('extrapolated_template.pkl',continuum='one')

sn=Pickle_Template('meanspec/meanspec_orig.p',continuum='one')
sn.get_lightcurve()
